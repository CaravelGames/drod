...
void CDrodScreenManager::GetScreenName(const UINT eScreen, string &strName) const
{
	switch (eScreen)
	{
		...
		case SCR_CreditsGatEB:    strName = "CreditsGatEB"; return;
		case SCR_CreditsJtRH:     strName = "CreditsJtRH"; return;
		case SCR_CreditsKDD:      strName = "CreditsKDD"; return;
		case SCR_CreditsTCB:      strName = "CreditsTCB"; return;
		case SCR_CreditsTSS:      strName = "CreditsTSS"; return;
		...
		case SCR_SellGatEB:       strName = "SellGatEB"; return;
		case SCR_SellJtRH:        strName = "SellJtRH"; return;
		case SCR_SellKDD:         strName = "SellKDD"; return;
		case SCR_SellTCB:         strName = "SellTCB"; return;
		case SCR_SellTSS:         strName = "SellTSS"; return;
...
//New screen object.
{
	switch (eScreen)
	{
		...
		case SCR_CreditsGatEB:
			return new CCreditsGatEBScreen;

		case SCR_CreditsJtRH:
			return new CCreditsJtRHScreen;

		case SCR_CreditsKDD:
			return new CCreditsKDDScreen;

		case SCR_CreditsTCB:
			return new CCreditsTCBScreen;

		case SCR_CreditsTSS:
			return new CCreditsTSSScreen;
		...
		case SCR_SellGatEB:
			return new CSellScreenGatEB;

		case SCR_SellJtRH:
			return new CSellScreenJtRH;

		case SCR_SellKDD:
			return new CSellScreenKDD;

		case SCR_SellTCB:
			return new CSellScreenTCB;

		case SCR_SellTSS:
			return new CSellScreenTSS;
