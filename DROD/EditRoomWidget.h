...
public:
	...
	bool           LoadFromRoom(CDbRoom *pRoom, CDbHold *pHold, vector<CMoveCoord*>* pLevelEntrances);
	...
	CDbHold        *pHold; //hold being edited
...
private:
	void           AddGentryiiSegmentEffect(const CMonster* pPlottingMonster);
