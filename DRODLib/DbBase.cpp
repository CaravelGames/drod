...
//to GetMessageText.
{
	...
	case MID_AttackTileRemove: strText = "Remove Monster"; break;
	...
	case MID_TargetBestBrainTile: strText = "Best brain tile"; break;
	...
	case MID_BumpActivateOrb: strText = "Body Strike Orbs/Beacons"; break;
	case MID_LightFuses: strText = "Light Fuses"; break;
	case MID_StepKill: strText = "Step Kill"; break;
	case MID_HasWeapon: strText = "Has Weapon"; break;
	case MID_UseMimicPotion: strText = "Drink Mimic Potion"; break;
	case MID_UseDecoyPotion: strText = "Drink Decoy Potion"; break;
	case MID_UseClonePotion: strText = "Drink Clone Potion"; break;
	case MID_UseInvisibilityPotion: strText = "Drink Invisibility Potion"; break;
	case MID_UseSpeedPotion: strText = "Drink Speed Potion"; break;
	case MID_UseSquadHorn: strText = "Blow Squad Horn"; break;
	...
	case MID_SolidOTileGroup: strText = "Any wall or closed door"; break;
