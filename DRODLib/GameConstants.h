...
#define CMD_DEMO_SEEK_010 (COMMAND_COUNT + 38)
#define CMD_DEMO_SEEK_020 (COMMAND_COUNT + 39)
#define CMD_DEMO_SEEK_030 (COMMAND_COUNT + 40)
#define CMD_DEMO_SEEK_040 (COMMAND_COUNT + 41)
#define CMD_DEMO_SEEK_050 (COMMAND_COUNT + 42)
#define CMD_DEMO_SEEK_060 (COMMAND_COUNT + 43)
#define CMD_DEMO_SEEK_070 (COMMAND_COUNT + 44)
#define CMD_DEMO_SEEK_080 (COMMAND_COUNT + 45)
#define CMD_DEMO_SEEK_090 (COMMAND_COUNT + 46)
#define CMD_DEMO_SEEK_100 (COMMAND_COUNT + 47)
#define CMD_DEMO_NEXT (COMMAND_COUNT + 48)
#define CMD_DEMO_PREV (COMMAND_COUNT + 49)
#define CMD_DEMO_SPEED_DOWN (COMMAND_COUNT + 50)
#define CMD_DEMO_SPEED_UP (COMMAND_COUNT + 51)
#define CMD_DEMO_PAUSE (COMMAND_COUNT + 52)
#define CMD_DEMO_UNIFORM_SPEED (COMMAND_COUNT + 53)
#define CMD_DEMO_GOTO (COMMAND_COUNT + 54)
