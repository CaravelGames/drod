// $Id: MonsterPiece.cpp 8102 2007-08-15 14:55:40Z trick $
...
//*****************************************************************************************
bool CMonsterPiece::OnStabbed(CCueEvents &CueEvents, const UINT /*wX*/, const UINT /*wY*/)
{
	return this->pMonster->OnStabbed(CueEvents, this->wX, this->wY);
}
