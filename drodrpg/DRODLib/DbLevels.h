// $Id: DbLevels.h 10146 2012-04-28 14:01:03Z mrimer $
...
public:
	...
	UINT       getItemAmount(const UINT item) const;
...
//	void       GetRequiredRooms(CIDSet& requiredRooms);
	...
	UINT       dwMultiplier;  //item stat multiplier in this level
...
public:
	...
	static void UpdateExitIDs(const UINT dwLevelID);
