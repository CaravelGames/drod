// $Id: SelectPlayerScreen.cpp 8686 2008-02-23 20:07:48Z mrimer $
...
const UINT TAG_LIST_BOX = 1090L;
const UINT TAG_CANCEL = 1091L;
const UINT TAG_NEWPLAYER = 1092L;
const UINT TAG_DELETEPLAYER = 1093L;
const UINT TAG_EXPORT = 1094L;
const UINT TAG_IMPORT = 1095L;
//const UINT TAG_EXPORTSAVES = 1096L;
...
//	static const int Y_BUTTONS3 = Y_BUTTONS2 + 40;
	static const int X_IMPORTBUTTON = X_EXPORTBUTTON + CX_EXPORTBUTTON + CX_SPACE;
	static const UINT CX_IMPORTBUTTON = 100;
	static const int X_CANCEL = X_IMPORTBUTTON + CX_IMPORTBUTTON + CX_SPACE;
	static const UINT CX_CANCEL = 100;

	static const UINT CY_BOX = Y_BUTTONS2 + CY_STANDARD_BUTTON + CY_SPACE;
...
*/
	this->pImportPlayerButton = new CButtonWidget(
			TAG_IMPORT, X_IMPORTBUTTON, Y_BUTTONS2, CX_IMPORTBUTTON, CY_STANDARD_BUTTON,
	...
	this->pPlayerBox->AddWidget(new CButtonWidget(
			TAG_CANCEL, X_CANCEL, Y_BUTTONS2, CX_CANCEL, CY_STANDARD_BUTTON,
...
const
{
	...
	//Get local players in DB.
	{
		CDb db;
#ifdef ENABLE_CHEATS
		db.Players.FilterByLocal(false);
#endif
		CDbPlayer *pPlayer = db.Players.GetFirst(true);
		while (pPlayer)
		{
			pPlayerListBoxWidget->AddItem(pPlayer->dwPlayerID, pPlayer->NameText, !pPlayer->bIsLocal);
			delete pPlayer;
