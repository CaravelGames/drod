// $Id: ParticleExplosionEffect.h 9096 2008-07-09 05:45:56Z mrimer $
...
protected:
	...
	CMoveCoord origin;
	const UINT wParticleTypes; //size of vectors
	...
	bool bRotatingParticles; //whether particles rotate
