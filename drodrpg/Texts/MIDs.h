...
enum MID_CONSTANT {
  ...
  //Messages from CreditsACR.uni:
  MID_Cr_ACR_Intro = 2117,
  MID_Cr_ACR_Producer_Title = 2118,
  MID_Cr_ACR_Producer = 2119,
  MID_Cr_ACR_Producer_Text = 2120,
  MID_Cr_ACR_LeadProgrammer_Title = 2121,
  MID_Cr_ACR_LeadProgrammer = 2122,
  MID_Cr_ACR_LeadProgrammer_Text = 2123,
  MID_Cr_ACR_Programmer_Title = 2124,
  MID_Cr_ACR_Programmer = 2125,
  MID_Cr_ACR_Programmer_Text = 2126,
  MID_Cr_ACR_MacPort_Title = 2127,
  MID_Cr_ACR_MacPort = 2128,
  MID_Cr_ACR_Music_Title = 2129,
  MID_Cr_ACR_Music = 2130,
  MID_Cr_ACR_Artwork_Title = 2131,
  MID_Cr_ACR_Artwork = 2132,
  MID_Cr_ACR_LevelDesign_Title = 2133,
  MID_Cr_ACR_LevelDesign = 2134,
  MID_Cr_ACR_FeatureDesign_Title = 2135,
  MID_Cr_ACR_FeatureDesign = 2136,
  MID_Cr_ACR_Story_Title = 2137,
  MID_Cr_ACR_Story = 2138,
  MID_Cr_ACR_CNet_Title = 2139,
  MID_Cr_ACR_CNet = 2140,
  MID_Cr_ACR_Web_Title = 2141,
  MID_Cr_ACR_Web = 2142,
  MID_Cr_ACR_VoiceCoord_Title = 2143,
  MID_Cr_ACR_VoiceCoord = 2144,
  MID_Cr_ACR_Voice_Title = 2145,
  MID_Cr_ACR_Voice = 2146,
  MID_Cr_ACR_Voice_Text = 2147,
  MID_Cr_ACR_Sound_Title = 2148,
  MID_Cr_ACR_Sound = 2149,
  MID_Cr_ACR_SoundEdit_Title = 2150,
  MID_Cr_ACR_SoundEdit = 2151,
  MID_Cr_ACR_TestCoord_Title = 2152,
  MID_Cr_ACR_TestCoord = 2153,
  MID_Cr_ACR_Test_Title = 2154,
  MID_Cr_ACR_Test = 2155,
  MID_Cr_ACR_Outro = 2156,
  MID_Cr_ACR_TheEnd = 2157,

  //Messages from CreditsTendry.uni:
  ...
  //Messages from GameLogging.uni:
  MID_GameLog_Collected = 2202,
  MID_GameLog_OpenedDoor = 2203,
  MID_GameLog_ClosedDoor = 2204,
  MID_GameLog_DugDirt = 2205,
  MID_GameLog_LitFuse = 2206,
  MID_GameLog_TileExploded = 2207,
  MID_GameLog_FoughtMonster = 2208,
  MID_GameLog_AttackByMonster = 2209,
  MID_GameLog_HitByBeam = 2210,
  MID_GameLog_HurtByTile = 2211,
  MID_GameLog_MonsterKilled = 2212,
  MID_GameLog_SwapWeapon = 2213,
  MID_GameLog_SwapShield = 2214,
  MID_GameLog_SwapAccessory = 2215,
  MID_GameLog_UseWeapon = 2216,
  MID_GameLog_UseShield = 2217,
  MID_GameLog_UseEquipment = 2218,
  MID_GameLog_UsePickaxe = 2219,
  MID_GameLog_UsePortableOrb = 2220,
  MID_GameLog_UseWarpToken = 2221,
  MID_GameLog_UseWallWalking = 2222,
  MID_GameLog_WarpWithAccessory = 2223,
  MID_GameLog_ScriptChangedStats = 2224,
  MID_GameLog_ScoreCheckpoint = 2225,
